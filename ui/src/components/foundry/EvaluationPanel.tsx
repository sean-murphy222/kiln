...
function ScoreBar({ score }: { score: CompetencyScore }) {
  ...
  return (
    <div className="flex items-center gap-3 py-1.5">
      <span className="text-sm text-kiln-300 w-48 truncate">
      ...
      <span
        className={cn(
          "px-1.5 py-0.5 rounded text-2xs font-medium w-20 text-center",
          rating.className,
        )}
      >
        {rating.label}
    ...
    <div className="p-4 space-y-4 animate-fade-in">
      ...
      <div className="flex items-center gap-6">
        <div className="text-center">
          <div className="text-3xl font-display font-bold text-kiln-100 tabular-nums">
            {pct}%
          </div>
        ...
        <div className="card p-4">
          ...
          <div className="flex gap-2">
            ...
            <button
              ...
              className={cn(
                "btn-primary btn-sm",
                (!selectedRunForEval || isRunning) && "opacity-50",
              )}
            >
              <Play size={12} />
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  ev.id === selectedEvalId
                    ? "bg-foundry-cast-faint"
                    : "hover:bg-kiln-700/30",
                )}
              >
                <div className="flex items-center justify-between mb-1">
                  ...
                  <span className="text-sm font-semibold text-kiln-100 tabular-nums">
                    {pct}%
                  </span>
                </div>
